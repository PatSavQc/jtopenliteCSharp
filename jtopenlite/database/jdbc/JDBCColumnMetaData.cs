	  ...
	  public static int getPrecision(Column column)
	  {
		...
		switch (0xFFFE & column.Type)
		{
		  ...
		  case DB2Type.VARCHAR:
			...
			case DB2Type.CLOB:
			case DB2Type.BLOB:
			precision = column.Length - 4;
			break;
			case DB2Type.DBCLOB:
			  precision = (column.Length - 4) / 2;
			break;
...
//ORIGINAL LINE: public static int getScale(Column column) throws java.sql.SQLException
